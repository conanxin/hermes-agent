...
### Docs
12. `project/website/docs/getting-started/quickstart.md` — Add gemini to provider table
13. `project/website/docs/user-guide/configuration.md` — Gemini setup section
14. `project/website/docs/reference/environment-variables.md` — New env vars
